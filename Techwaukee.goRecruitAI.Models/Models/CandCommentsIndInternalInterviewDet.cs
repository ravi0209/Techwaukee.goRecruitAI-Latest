...
public partial class CandCommentsIndInternalInterviewDet
{
    public int Candcommentinterviewid { get; set; }
    ...
    public DateTime? IntSchdate { get; set; }

    public string? Intcomgivenby { get; set; }

    public DateTime? Intcomgivenon { get; set; }

    public string? Intcomgiventime { get; set; }

    public string? Intupdategivenby { get; set; }

    public DateTime? Intupdategivenon { get; set; }
    ...
    public DateTime? Mgrcomgivenon { get; set; }

    public string? Mgrcomgiventime { get; set; }

    public string? Mgrupdategivenby { get; set; }

    public DateTime? Mgrupdategivenon { get; set; }

    public string? Mgrupdategiventime { get; set; }

    public DateTime? MgrAppdate { get; set; }

    public DateTime? MgrRejdate { get; set; }
}